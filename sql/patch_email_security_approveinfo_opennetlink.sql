...
*/
  ...
  sql:='WITH TBL_EMAIL_TRANSFER AS 
	...
	(  
		...
		WHERE ((A.APPR_REQ_TIME BETWEEN ''##FROMDATE##000000'' AND ''##TODATE##235959'' ) AND (##ISSECURITY##))
	...
	-- RAISE NOTICE 'Quantity here is %', sql;
...
ALTER FUNCTION public.func_email_approveinfo_open(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying)
    OWNER TO postgres;
