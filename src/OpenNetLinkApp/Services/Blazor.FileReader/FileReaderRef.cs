...
namespace Blazor.FileReader
{
    ...
    public interface IFileReaderRef
    {
        ...
        /// </summary>
        /// <param name="targetId"> targetId is Id of HTMLElement.</param>
        /// <returns></returns>
        Task SetDragTargetElementAsync(string targetId);

        /// <summary>
        /// Delete from List(Set()) for element Id on the source element
        /// </summary>
        /// <param name="targetId"> targetId is Id of HTMLElement.</param>
        /// <returns></returns>
        Task DelDragTargetElementAsync(string targetId);
