...
namespace OpenNetLinkApp.Services.SGAppManager
{
    ...
    internal class SGSiteConfigService : ISGSiteConfigService
    {
        ...
        public bool m_bUseStartTrayMove { get; set; } = true;                              // 프로그램 시작 시 트레이 이동 사용 유무.
        ...
        public bool m_bClipBoardNoApproveButFileTrans { get; set; } = true;                // 클립보드 파일 전송 시 결재 없이 클립보드 전송(파일 전송시 결재 정보에 빈값을 보낸다) Default 값 true 로 변경 (smkoo)
