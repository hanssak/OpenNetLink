...

{
    public interface ISGopConfig
    {
        ...
        public int nPWChangeApplyCnt { get; set; }                // 패스워드 변경 시, 최소자리수

        public int nPWkeyBoardLinearCharCnt { get; set; }         // 패스워드 변경 시, 키보드상에 최소자리수
        public int nPWsameCharCnt { get; set; }                   // 패스워드 변경 시, 연속된 같은 문자수
        public int nPWchangeRuleCnt { get; set; }                 // 패스워드 변경 시, 대문자/소문자/수/특수문자 중에 최소한 적용되어야할 법칙 개수
        ...
        public string strDlpFoundSendBlockDest { get; set; } // 개인정보 검출 시 전송 차단 Dest망
        ...
        public bool bUseApproveExtRegardlessApprove { get; set; }                         // 결재상관없이 결재 필수 확장자 검색
        public int nMethodApproveExtRegardlessApprove { get; set; }                       // 결재상관없이 결재 필수 확장자 검색되었을때 처리 방법
        public string strApproveExtRegardlessApproveDest { get; set; }                   // 결재상관없이 결재 필수 확장자 검색되었을 경우 처리방법 적용할 Dest
