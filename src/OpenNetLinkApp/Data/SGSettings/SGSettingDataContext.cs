...
namespace OpenNetLinkApp.Data.SGSettings
{
    ...
    public sealed class SGSettingsDBProc
    {
        ...
        {
            // Create
            Log.Logger.Here().Debug($"Inserting a SettingData, GROUPID:{groupId}, UID:{uid}, APPRLINE:{apprline}, DELAYDSPPW:{delayDspPw}, AUTOLOGIN:{autoLoginUse}");
        ...
        {
            // Create
            Log.Logger.Here().Debug($"Updating a SettingData, GROUPID:{groupId}, UID:{uid}, APPRLINE:{apprline}, DELAYDSPPW:{delayDspPw}, AUTOLOGIN:{autoLoginUse}");
        ...
        {
            // Create
            Log.Logger.Here().Debug($"Updating a SettingData, GROUPID:{obj.GROUPID}, UID:{obj.UID}, APPRLINE:{obj.APPRLINE}, DELAYDSPPW:{obj.DELAYDISPLAYPW}, AUTOLOGIN:{obj.AUTOLOGINING}");
            lock (_locker)
            {
        ...
        {
            // Create
            Log.Logger.Here().Debug($"Set a SettingData, GROUPID({groupId})=>UID({uid})");
        ...
        {
            // Create
            Log.Logger.Here().Debug($"Set a SettingData, GROUPID({groupId})=>UPW({(HsNetWorkSG.HsNetWork.UseHiddenLog ? upw : "xxx")})");
            SGSettingData SData;
        ...
        {
            // Create
            Log.Logger.Here().Debug($"Set a SettingData, GROUPID({groupId})=>APPRLINE({apprline})");
            SGSettingData SData;
        ...
        {
            // Create
            Log.Logger.Here().Debug($"Set a SettingData, GROUPID({groupId})=>DELAYDISPLAYPW({delayDspPw})");
            SGSettingData SData;
        ...
        {
            // Create
            Log.Logger.Here().Debug($"Set a SettingData, GROUPID({groupId})=>AUTOLOGINING({autoLogin})");
            SGSettingData SData;
        ...
        public List<SGSettingData> SelectSettingDataList(int groupId, int nLimit)
        {
            ...
            Log.Logger.Here().Debug($"Querying for a SGSettingData Limit {nLimit}");
            return SDataList;
        }
        ...
        public SGSettingData SelectSettingData(int groupId)
        {
            ...
            Log.Logger.Here().Debug($"Querying for a SGSettingData {SData}");
            return SData;
        }
        ...
        public bool DeleteSettingData(SGSettingData settingData)
        {
            ...
            Log.Logger.Here().Debug($"Delete the SGSettingData, {settingData}");
