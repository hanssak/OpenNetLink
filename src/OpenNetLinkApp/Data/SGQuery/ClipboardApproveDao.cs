...
namespace OpenNetLinkApp.Data.SGQuery
{
    class ClipboardApproveDao
    {
		public string List(ApproveParam tParam)
		{
			...
			sb.Append("     (select count(*) from tbl_forward_info_his where trans_seq = a.trans_seq)) > 0  THEN '1' ELSE '0' END as forward_type, a.data_type AS dataType  ");
