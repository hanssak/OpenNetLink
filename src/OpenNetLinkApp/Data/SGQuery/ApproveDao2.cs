...
namespace OpenNetLinkApp.Data.SGQuery
{
    ...
    class ApproveDao2
    {
		...
		public string List(ApproveParam tParam, bool bNoClipboard, string[] strArrClipDataType = null)
		{
			...
			sb.Append(@" ,d.src_system_id, d.dest_system_id,	
...
");
			...
			sb.Append(")");
			sb.Append("        AND approve_user_seq <> user_seq ");
			sb.Append("  ) b, tbl_user_info c, tbl_transfer_req_sub_his d, tbl_user_info e ");
			sb.Append("  WHERE a.trans_seq = d.trans_seq AND a.trans_seq = b.trans_seq AND a.user_seq = c.user_seq AND b.approve_user_seq = e.user_seq AND a.user_seq <> b.approve_user_seq ");
			if (!(tParam.SearchFromDay.Equals("")) && (tParam.SearchToDay.Equals("")))
...
");
			...
			sb.Append("        AND approve_user_seq <> user_seq ");
			sb.Append("  ) b, tbl_user_info c, tbl_transfer_req_sub_his d, tbl_user_info e");
			sb.Append("  WHERE d.trans_seq = a.trans_seq AND a.trans_seq = b.trans_seq AND a.user_seq = c.user_seq AND b.approve_user_seq = e.user_seq AND a.user_seq <> b.approve_user_seq ");
			if (bNoClipboard)
				sb.Append("AND  a.data_type=0");
			else
				sb.Append(GetClipDataSearch(strArrClipDataType));
