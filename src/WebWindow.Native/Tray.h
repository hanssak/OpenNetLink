...
static wchar_t g_tooltipTitle[512];
static wchar_t g_trayShow[512];
static wchar_t g_trayHide[512];
static wchar_t g_trayExit[512];
static wchar_t g_trayHyphen[512];
...
static int tray_init(struct tray* tray) {
   ...
   // nid.hIcon = icon;
	...
	lstrcpy(nid.szTip, g_tooltipTitle);
...
static int tray_text(AutoString tooltip, AutoString show, AutoString hide, AutoString exit, AutoString hyphen)
{
	wcscpy(g_tooltipTitle, tooltip);
	wcscpy(g_trayShow, show);
	wcscpy(g_trayHide, hide);
	wcscpy(g_trayExit, exit);
	wcscpy(g_trayHyphen, hyphen);
